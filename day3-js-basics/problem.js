...
let randomNum = Math.floor(Math.random() * 10) + 1; // Q9 random
let converted = Number("123") + 10;                 // Q10 convert

// ---- Booleans ----
let looseEqual = (10 == "10");    // Q11 loose equality
let strictEqual = (10 === "10");  // strict equality

let num = 75;                     // Q12 range check
let inRange = (num > 50 && num < 100);

let isTrue = true;                // Q13 NOT operator
let inverted = !isTrue;

let x = 8, y = 3;                 // Q14 OR condition
let condition = (x > 10 || y < 5);

let valueNull = null;             // Q15 null/undefined types
let valueUndefined;
...
let trick4 = (null == undefined);   // true
let trick5 = (null === undefined);  // false

// Q5: typeof NaN ?
let trick6 = typeof NaN; // "number"
